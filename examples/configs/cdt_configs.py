...
class CDTCarRunConfig(CDTTrainConfig):
    ...
    target_returns: Tuple[Tuple[float, ...], ...] = ((575.0, 10), 
                                                     (575.0, 20), 
                                                     (575.0, 40))
    # augmentation param
    deg: int = 0
...
class CDTBallRunConfig(CDTTrainConfig):
    ...
    target_returns: Tuple[Tuple[float, ...], ...] = ((500.0, 10), 
                                                     (500.0, 20), 
                                                     (700.0, 40))
    # augmentation param
    deg: int = 2
...
class CDTCarButton1Config(CDTTrainConfig):
    ...
    target_returns: Tuple[Tuple[float, ...], ...] = ((35.0, 20), 
                                                     (35.0, 40), 
                                                     (35.0, 80))
    # augmentation param
    deg: int = 0
...
class CDTCarCircle1Config(CDTTrainConfig):
    ...
    target_returns: Tuple[Tuple[float, ...], ...] = ((20.0, 20), 
                                                     (22.5, 40), 
                                                     (25.0, 80))
    # augmentation param
    deg: int = 1
...
class CDTCarPush1Config(CDTTrainConfig):
    ...
    target_returns: Tuple[Tuple[float, ...], ...] = ((15.0, 20), 
                                                     (15.0, 40), 
                                                     (15.0, 80))
    # augmentation param
    deg: int = 0
...
class CDTCarPush2Config(CDTTrainConfig):
    ...
    target_returns: Tuple[Tuple[float, ...], ...] = ((12.0, 20), 
                                                     (12.0, 40), 
                                                     (12.0, 80))
    # augmentation param
    deg: int = 0
...
class CDTPointCircle1Config(CDTTrainConfig):
    ...
    target_returns: Tuple[Tuple[float, ...], ...] = ((50.0, 20), 
                                                     (52.5, 40), 
                                                     (55.0, 80))
    # augmentation param
    deg: int = 1
...
class CDTPointCircle2Config(CDTTrainConfig):
    ...
    target_returns: Tuple[Tuple[float, ...], ...] = ((45.0, 20), 
                                                     (47.5, 40), 
                                                     (50.0, 80))
    # augmentation param
    deg: int = 1
...
class CDTHopperVelocityConfig(CDTTrainConfig):
    ...
    target_returns: Tuple[Tuple[float, ...], ...] = ((1750.0, 20), 
                                                     (1750.0, 40), 
                                                     (1750.0, 80))
    # augmentation param
    deg: int = 1
